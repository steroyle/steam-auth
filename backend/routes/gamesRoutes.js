...
router.get('/recently-played', async (request, response) => {    
    const url = `http://api.steampowered.com/IPlayerService/GetRecentlyPlayedGames/v0001/?key=${process.env.STEAM_API_KEY}&steamid=${request.user.steamId}&format=json`;
